...
// import ZipUtils; var e = ZipUtils.createZipFile("gjnsdghs.ycemod"); ZipUtils.writeFolderToZip(e, #if !mobile './' + #end "mods/Friday Night Funkin'/", "Friday Night Funkin'/"); e.flush(); e.close();
