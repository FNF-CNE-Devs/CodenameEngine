		...
		if (stageXML != null)
		{
			...
			if (PlayState.instance != null)
			{
				if (stageXML.has.zoom)
				{
					...
					if (parsed != null && PlayState.instance != null)
						PlayState.instance.defaultCamZoom = parsed;
				}
			...
			for (node in stageXML.elements)
			{
				var sprite:Dynamic = switch (node.name)
				{
					case "sprite" | "spr" | "sparrow":
						if (!node.has.sprite || !node.has.name || !node.has.x || !node.has.y)
							continue;
					...
					case "girlfriend" | "gf":
						if (PlayState.instance == null || PlayState.instance.gf == null)
							continue;
					...
					case "ratings" | "combo":
						if (PlayState.instance == null)
							continue;
						PlayState.instance.comboGroup.setPosition(Std.parseFloat(node.getAtt("x")).getDefault(PlayState.instance.comboGroup.x),
					...
					case "dad" | "opponent":
						if (PlayState.instance == null || PlayState.instance.dad == null || PlayState.instance.dad.isGF)
							continue;
